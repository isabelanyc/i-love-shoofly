...
const routes = {
  about: () => `
    <section class="page about-page"><div class="about-grid">
      ...
      <div><p class="lead">This is a love letter to shoofly pie from an English fan who didn&rsquo;t grow up Amish or Pennsylvania Dutch—and fell hard for the molasses, crumb, and history anyway.</p><p>What began as a personal Google Maps list became a way to celebrate this distinctly sweet treat and the bakeries, markets, and roadside stands that keep it alive. Use the map to find a slice, plan a detour, and share the places still missing.</p><div class="about-actions"><a class="button button-primary" href="#/map">Find a slice</a><a class="text-link" href="#/what">What is shoofly? ↗</a></div></div>
