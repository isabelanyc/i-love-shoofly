...
const routes = {
  ...
  what: () => `
    <section class="page what-page">
      ...
      <section class="preference-block"><div class="preference-copy"><p class="section-kicker">The people have spoken</p><h2>Wet wins the vote.<br>Both win at the table.</h2><div class="survey-stat"><strong>96%</strong><span>chose wet bottom</span></div><p>In a LancasterOnline reader survey, the gooey molasses layer was the clear favorite—but dry bottom&rsquo;s tender, coffee-cake crumb is delicious in its own right. The best kind is the slice in front of you.</p></div><figure><img src="assets/shoofly-preference-survey.webp" alt="LancasterOnline survey graphic showing 96 percent prefer wet-bottom shoofly pie and 4 percent prefer dry bottom" width="723" height="1200"><figcaption>Graphic: <a href="https://lancasteronline.com/features/food/pa-dutch-eats-shoofly-pie-is-lancaster-s-sweetest-gooiest-treat-video-recipe/article_1a273262-603a-11e8-b27b-d7b1589c2d3d.html" target="_blank" rel="noreferrer">LancasterOnline reader survey ↗</a></figcaption></figure></section>
