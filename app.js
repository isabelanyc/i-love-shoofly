  ...
  what: () => `
    <section class="page what-page">
      ...
      <div class="pie-comparison">
        <article class="comparison-card"><img src="assets/shoofly-wet-bottom.webp" alt="A slice of wet-bottom shoofly pie showing a glossy molasses layer beneath a cakey crumb top" width="1200" height="900"><div class="comparison-copy"><p class="comparison-number">01 · The gooey one</p><h2>Wet bottom</h2><p>A dark molasses layer settles along the crust while the crumb mixture bakes into a soft, cakey top. The result is distinctly layered, sticky, and almost custard-like at the base.</p><dl><div><dt>Texture</dt><dd>Gooey below, cakey above</dd></div><div><dt>Look for</dt><dd>A glossy bottom layer</dd></div></dl></div></article>
        <article class="comparison-card"><img src="assets/shoofly-dry-bottom.webp" alt="A slice of dry-bottom shoofly pie showing an evenly baked cake-like molasses crumb" width="1200" height="900"><div class="comparison-copy"><p class="comparison-number">02 · The cakey one</p><h2>Dry bottom</h2><p>The molasses and crumbs bake together more uniformly, leaving little or no syrupy layer at the base. It eats more like a tender molasses coffee cake tucked inside a pastry crust.</p><dl><div><dt>Texture</dt><dd>Evenly firm and cakey</dd></div><div><dt>Look for</dt><dd>One consistent crumb</dd></div></dl></div></article>
      </div>
