...
const routes = {
  about: () => `
    <section class="page about-page"><div class="about-grid">
      ...
      <div><p class="lead">This is an Englisher&rsquo;s love letter to shoofly pie—from someone outside the Amish and Pennsylvania Dutch communities, with deep appreciation for the people, places, and traditions that keep it alive.</p><p>What began as a personal Google Maps list became a way to celebrate this distinctly sweet treat and the bakeries, markets, and roadside stands that keep it alive. Use the map to find a slice, plan a detour, and share the places still missing.</p><div class="about-actions"><a class="button button-primary" href="#/map">Find a slice</a><a class="text-link" href="#/what">What is shoofly? ↗</a></div></div>
