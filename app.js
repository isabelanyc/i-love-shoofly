...
const routes = {
  ...
  what: () => `
    <section class="page what-page">
      <header class="what-intro"><div><p class="section-kicker">What is shoofly pie?</p><h1 class="route-title">Wet bottom vs. dry bottom.</h1></div><p>Both styles begin with pastry, molasses, and a brown-sugar crumb. The difference is what happens inside the slice: one stays sticky and layered; the other bakes into an even, cake-like crumb.</p></header>
      <div class="pie-comparison" aria-label="Wet-bottom and dry-bottom shoofly pie comparison"><span class="comparison-vs" aria-hidden="true">vs.</span>
        <article class="comparison-card"><figure><img src="assets/shoofly-wet-bottom.webp" alt="A slice of wet-bottom shoofly pie showing a glossy molasses layer beneath a crumb top" width="1200" height="900"><figcaption>Photo: <a href="https://www.thekitchn.com/kll-shoofly-pie-pi-day-recipe-23295288" target="_blank" rel="noreferrer">The Kitchn ↗</a></figcaption></figure><div class="comparison-copy"><p class="comparison-number">01 · The gooey one</p><h2>Wet bottom</h2><p>A dark molasses layer settles along the crust while the crumb mixture bakes into a soft, cakey top. The result is distinctly layered, sticky, and almost custard-like at the base.</p><dl><div><dt>Texture</dt><dd>Gooey below, cakey above</dd></div><div><dt>Look for</dt><dd>A glossy bottom layer</dd></div></dl></div></article>
        <article class="comparison-card"><figure><img src="assets/shoofly-dry-bottom.webp" alt="A slice of dry-bottom shoofly pie showing its more evenly baked interior" width="752" height="500"><figcaption>Photo: <a href="https://lancasteronline.com/features/food/pa-dutch-eats-shoofly-pie-is-lancaster-s-sweetest-gooiest-treat-video-recipe/article_1a273262-603a-11e8-b27b-d7b1589c2d3d.html" target="_blank" rel="noreferrer">LancasterOnline ↗</a></figcaption></figure><div class="comparison-copy"><p class="comparison-number">02 · The cakey one</p><h2>Dry bottom</h2><p>The molasses and crumbs bake together more uniformly, leaving little or no syrupy layer at the base. It eats more like a tender molasses coffee cake tucked inside a pastry crust.</p><dl><div><dt>Texture</dt><dd>Evenly firm and cakey</dd></div><div><dt>Look for</dt><dd>One consistent crumb</dd></div></dl></div></article>
      </div>
      <section class="preference-block"><div class="preference-copy"><p class="section-kicker">The people have spoken</p><h2>Wet wins the vote.<br>Both win at the table.</h2><div class="survey-stat"><strong>96%</strong><span>chose wet bottom</span></div><p>In a LancasterOnline reader survey, the gooey molasses layer was the clear favorite—but dry bottom&rsquo;s tender, coffee-cake crumb is delicious in its own right. The best kind is the slice in front of you.</p></div><figure><img src="assets/shoofly-preference-survey.webp" alt="LancasterOnline survey graphic showing 96 percent prefer wet-bottom shoofly pie and 4 percent prefer dry bottom" width="1063" height="848"><figcaption>Graphic: <a href="https://lancasteronline.com/features/food/pa-dutch-eats-shoofly-pie-is-lancaster-s-sweetest-gooiest-treat-video-recipe/article_1a273262-603a-11e8-b27b-d7b1589c2d3d.html" target="_blank" rel="noreferrer">LancasterOnline reader survey ↗</a></figcaption></figure></section>
      <p class="inline-source">Neither style is the “right” one—it comes down to family recipe and personal preference. Read more about the distinction at <a href="https://www.epicurious.com/recipes-menus/history-of-shoofly-pie" target="_blank" rel="noreferrer">Epicurious</a> and <a href="https://www.shady-maple.com/history-of-shoofly-pie/" target="_blank" rel="noreferrer">Shady Maple</a>.</p>
    </section>`,
  map: () => `
  ...
  history: () => `
    <section class="page history-page">
      ...
      <div class="history-notes">
        <article><p class="history-label">The community</p><h2>A food born in Pennsylvania Dutch kitchens.</h2><p>Shoofly pie began with Pennsylvania&rsquo;s German-speaking communities, including Amish, Mennonite, Moravian, and other Pennsylvania Dutch families. Their practical baking traditions turned pantry staples—molasses, flour, sugar, and leavening—into the pie that became a regional icon. The <a href="https://philadelphiaencyclopedia.org/essays/dutch-netherlands/" target="_blank" rel="noreferrer">Encyclopedia of Greater Philadelphia</a> offers more context on these Pennsylvania German communities.</p></article>
