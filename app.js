...
const routes = {
  ...
  what: () => `
    <section class="page what-page">
      <header class="what-intro"><div><p class="section-kicker">What is shoofly pie?</p><h1 class="route-title">Wet bottom<br>vs. dry bottom.</h1></div><p>Both styles begin with pastry, molasses, and a brown-sugar crumb. The difference is what happens inside the slice: one stays sticky and layered; the other bakes into an even, cake-like crumb.</p></header>
